...
public class ProtocolDeclAdapter extends EObjectAdapter<ProtocolDecl> implements org.archware.sosadl.gemoc.xsosadlmt.sosADL.ProtocolDecl {
  ...
  public EClass eClass() {
    return org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.eINSTANCE.getProtocolDecl();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.PROTOCOL_DECL__NAME:
    		return getName();
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.PROTOCOL_DECL__BODY:
    		return getBody();
    }
