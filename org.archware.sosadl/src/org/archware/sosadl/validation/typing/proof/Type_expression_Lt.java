...
@CoqNoStandalone
public class Type_expression_Lt<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Lt(Environment gamma, Expression l, DataType l__tau, Expression l__min, Expression l__max,
