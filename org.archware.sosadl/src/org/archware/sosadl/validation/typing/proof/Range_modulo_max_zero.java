...
public class Range_modulo_max_zero implements Range_modulo_max {
	@Mandatory
	...
	public Range_modulo_max_zero(Expression lmin, Expression lmax, Expression rmin, Expression rmax, Expression min,
