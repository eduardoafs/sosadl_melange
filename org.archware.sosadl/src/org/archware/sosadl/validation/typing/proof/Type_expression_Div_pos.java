...
@CoqNoStandalone
public class Type_expression_Div_pos<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Div_pos(Environment gamma, Expression l, DataType l__tau, Expression l__min,
