...
public class IfThenElseProtocolAdapter extends EObjectAdapter<IfThenElseProtocol> implements org.archware.sosadl.gemoc.xsosadlmt.sosADL.IfThenElseProtocol {
  ...
  public void setIfTrue(final Protocol o) {
    if (o != null)
    	adaptee.setIfTrue(((org.archware.sosadl.gemoc.xsosadl.adapters.xsosadlmt.sosADL.ProtocolAdapter) o).getAdaptee());
  ...
  public void setIfFalse(final Protocol o) {
    if (o != null)
    	adaptee.setIfFalse(((org.archware.sosadl.gemoc.xsosadl.adapters.xsosadlmt.sosADL.ProtocolAdapter) o).getAdaptee());
    else adaptee.setIfFalse(null);
  }
  
  @Override
  public EClass eClass() {
    return org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.eINSTANCE.getIfThenElseProtocol();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.IF_THEN_ELSE_PROTOCOL__CONDITION:
    		return getCondition();
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.IF_THEN_ELSE_PROTOCOL__IF_TRUE:
    		return getIfTrue();
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.IF_THEN_ELSE_PROTOCOL__IF_FALSE:
    		return getIfFalse();
    }
