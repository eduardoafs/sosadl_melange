...
public class DoExprProtocolAdapter extends EObjectAdapter<DoExprProtocol> implements org.archware.sosadl.gemoc.xsosadlmt.sosADL.DoExprProtocol {
  private XSosadlMTAdaptersFactory adaptersFactory;
  
  public DoExprProtocolAdapter() {
  ...
  public EClass eClass() {
    return org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.eINSTANCE.getDoExprProtocol();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.DO_EXPR_PROTOCOL__EXPRESSION:
