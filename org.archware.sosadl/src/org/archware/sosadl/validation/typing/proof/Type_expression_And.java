...
@CoqNoStandalone
public class Type_expression_And<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_And(Environment gamma, Expression l, DataType l__tau, Expression r, DataType r__tau, T p1,
			Subtype p2, T p3, Subtype p4) {
		super();
		this.gamma = gamma;
		this.l = l;
		this.l__tau = l__tau;
