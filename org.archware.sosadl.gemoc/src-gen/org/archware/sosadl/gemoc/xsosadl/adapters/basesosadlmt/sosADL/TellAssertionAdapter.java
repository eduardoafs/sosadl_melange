...
public class TellAssertionAdapter extends EObjectAdapter<TellAssertion> implements org.archware.sosadl.sosADL.TellAssertion {
  private BaseSosADLMTAdaptersFactory adaptersFactory;
  
  public TellAssertionAdapter() {
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getTellAssertion();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.TELL_ASSERTION__NAME:
    		return getName();
    	case org.archware.sosadl.sosADL.SosADLPackage.TELL_ASSERTION__EXPRESSION:
