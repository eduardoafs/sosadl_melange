...
public class Range_modulo_max_pos implements Range_modulo_max {
	@Mandatory
	...
	public Range_modulo_max_pos(Expression lmin, Expression lmax, Expression rmin, Expression rmax, Expression min,
