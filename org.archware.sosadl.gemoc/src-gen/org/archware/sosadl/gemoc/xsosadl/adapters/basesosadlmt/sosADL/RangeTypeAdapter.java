...
public class RangeTypeAdapter extends EObjectAdapter<RangeType> implements org.archware.sosadl.sosADL.RangeType {
  ...
  public void setVmin(final Expression o) {
    if (o != null)
    	adaptee.setVmin(((org.archware.sosadl.gemoc.xsosadl.adapters.basesosadlmt.sosADL.ExpressionAdapter) o).getAdaptee());
  ...
  public void setVmax(final Expression o) {
    if (o != null)
    	adaptee.setVmax(((org.archware.sosadl.gemoc.xsosadl.adapters.basesosadlmt.sosADL.ExpressionAdapter) o).getAdaptee());
    else adaptee.setVmax(null);
  }
  
  @Override
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getRangeType();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.RANGE_TYPE__VMIN:
    		return getVmin();
    	case org.archware.sosadl.sosADL.SosADLPackage.RANGE_TYPE__VMAX:
    		return getVmax();
    }
