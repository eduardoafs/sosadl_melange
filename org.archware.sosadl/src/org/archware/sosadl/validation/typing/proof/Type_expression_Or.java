...
@CoqNoStandalone
public class Type_expression_Or<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Or(Environment gamma, Expression l, DataType l__tau, Expression r, DataType r__tau, T p1,
