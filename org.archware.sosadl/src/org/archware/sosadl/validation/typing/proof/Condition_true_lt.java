...
public class Condition_true_lt implements Condition_true {
	@Mandatory
	...
	public Condition_true_lt(Environment gamma, String x, Expression x_min, Expression x_max, Expression x_max_,
