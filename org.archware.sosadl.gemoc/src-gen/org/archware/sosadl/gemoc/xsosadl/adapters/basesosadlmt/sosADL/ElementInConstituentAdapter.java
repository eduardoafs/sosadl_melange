...
public class ElementInConstituentAdapter extends EObjectAdapter<ElementInConstituent> implements org.archware.sosadl.sosADL.ElementInConstituent {
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getElementInConstituent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.ELEMENT_IN_CONSTITUENT__VARIABLE:
    		return getVariable();
    	case org.archware.sosadl.sosADL.SosADLPackage.ELEMENT_IN_CONSTITUENT__CONSTITUENT:
