...
public class DataTypeDeclAdapter extends EObjectAdapter<DataTypeDecl> implements org.archware.sosadl.gemoc.xsosadlmt.sosADL.DataTypeDecl {
  ...
  public void setDatatype(final DataType o) {
    if (o != null)
    	adaptee.setDatatype(((org.archware.sosadl.gemoc.xsosadl.adapters.xsosadlmt.sosADL.DataTypeAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.eINSTANCE.getDataTypeDecl();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.DATA_TYPE_DECL__NAME:
    		return getName();
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.DATA_TYPE_DECL__DATATYPE:
    		return getDatatype();
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.DATA_TYPE_DECL__FUNCTIONS:
    		return getFunctions();
    }
