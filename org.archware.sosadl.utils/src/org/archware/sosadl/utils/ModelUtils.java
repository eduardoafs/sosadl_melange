package org.archware.sosadl.utils;
...
public class ModelUtils {
	...
	/**
	 * since Melange transforms the k3 code when creating the runtimelanguage
	 * K3 cannot call directly the resolve(archware.sosadl.sosADL.*) methods
	 * as they won't exist for the new type  but only on the base
	 * This method allows to workaroud using reflection
	 * @param e
	 * @return
	 */
	public static EObject resolve_MelangeK3Dispatch(EObject e) {
		if(e instanceof IdentExpression) {
			return resolve((IdentExpression)e);
		} else if(e instanceof ComplexName) {
			return resolve((ComplexName)e);
		} else {
			return null;
		}
	}
	...
	public static Constituent findConstituent(ComplexName n) {
		...
		ArchBehaviorDecl e = (ArchBehaviorDecl) org.archware.sosadl.utils.ModelUtils.upUntilFind(n, ArchBehaviorDecl.class);
