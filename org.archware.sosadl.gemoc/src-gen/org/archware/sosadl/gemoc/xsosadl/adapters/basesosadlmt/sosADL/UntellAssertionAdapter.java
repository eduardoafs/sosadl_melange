...
public class UntellAssertionAdapter extends EObjectAdapter<UntellAssertion> implements org.archware.sosadl.sosADL.UntellAssertion {
  private BaseSosADLMTAdaptersFactory adaptersFactory;
  
  public UntellAssertionAdapter() {
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getUntellAssertion();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.UNTELL_ASSERTION__NAME:
    		return getName();
    }
