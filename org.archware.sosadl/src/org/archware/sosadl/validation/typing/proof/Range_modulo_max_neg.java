...
public class Range_modulo_max_neg implements Range_modulo_max {
	@Mandatory
	...
	public Range_modulo_max_neg(Expression lmin, Expression lmax, Expression rmin, Expression rmax, Expression min,
