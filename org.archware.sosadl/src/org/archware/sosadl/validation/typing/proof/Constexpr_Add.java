...
public class Constexpr_Add implements Constexpr_expression {
	@Mandatory
	...
	public Constexpr_Add(Expression l, Expression r, Constexpr_expression p1, Constexpr_expression p2) {
		super();
		this.l = l;
		this.r = r;
		this.p1 = p1;
