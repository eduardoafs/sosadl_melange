...
public class FunctionDeclAdapter extends EObjectAdapter<FunctionDecl> implements org.archware.sosadl.sosADL.FunctionDecl {
  ...
  public void setData(final FormalParameter o) {
    if (o != null)
    	adaptee.setData(((org.archware.sosadl.gemoc.xsosadl.adapters.basesosadlmt.sosADL.FormalParameterAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getFunctionDecl();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__DATA:
    		return getData();
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__NAME:
    		return getName();
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__PARAMETERS:
    		return getParameters();
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__TYPE:
    		return getType();
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__VALUING:
    		return getValuing();
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__EXPRESSION:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__DATA:
    		setData(
    		(org.archware.sosadl.sosADL.FormalParameter)
    		 newValue);
    		return;
    	case org.archware.sosadl.sosADL.SosADLPackage.FUNCTION_DECL__NAME:
    		setName(
