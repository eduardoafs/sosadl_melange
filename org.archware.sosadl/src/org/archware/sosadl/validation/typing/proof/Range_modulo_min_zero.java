...
public class Range_modulo_min_zero implements Range_modulo_min {
	@Mandatory
	...
	public Range_modulo_min_zero(Expression lmin, Expression lmax, Expression rmin, Expression rmax, Expression min,
