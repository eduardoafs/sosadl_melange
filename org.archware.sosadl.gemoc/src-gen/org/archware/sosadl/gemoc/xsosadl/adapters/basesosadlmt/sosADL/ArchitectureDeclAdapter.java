...
public class ArchitectureDeclAdapter extends EObjectAdapter<ArchitectureDecl> implements org.archware.sosadl.sosADL.ArchitectureDecl {
  ...
  public void setBehavior(final ArchBehaviorDecl o) {
    if (o != null)
    	adaptee.setBehavior(((org.archware.sosadl.gemoc.xsosadl.adapters.basesosadlmt.sosADL.ArchBehaviorDeclAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getArchitectureDecl();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__NAME:
    		return getName();
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__PARAMETERS:
    		return getParameters();
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__DATATYPES:
    		return getDatatypes();
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__GATES:
    		return getGates();
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__BEHAVIOR:
    		return getBehavior();
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__ASSERTIONS:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__BEHAVIOR:
    		setBehavior(
    		(org.archware.sosadl.sosADL.ArchBehaviorDecl)
    		 newValue);
    		return;
    	case org.archware.sosadl.sosADL.SosADLPackage.ARCHITECTURE_DECL__ASSERTIONS:
    		getAssertions().clear();
