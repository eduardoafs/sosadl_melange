...
@CoqNoStandalone
public class Type_expression_Xor<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Xor(Environment gamma, Expression l, DataType l__tau, Expression r, DataType r__tau, T p1,
