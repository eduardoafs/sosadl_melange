...
@CoqNoStandalone
public class Type_expression_Mul<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Mul(Environment gamma, Expression l, DataType l__tau, Expression l__min, Expression l__max,
			...
			Subtype p2, T p3, Subtype p4, Expression_le p5, Expression_le p6, Expression_le p7, Expression_le p8,
			Expression_le p9, Expression_le pa, Expression_le pb, Expression_le pc) {
		super();
		this.gamma = gamma;
		this.l = l;
		this.l__tau = l__tau;
