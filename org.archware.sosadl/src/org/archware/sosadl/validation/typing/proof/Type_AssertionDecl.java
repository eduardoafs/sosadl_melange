...
public class Type_AssertionDecl implements Type_assertion {
	@Mandatory
	...
	public Type_AssertionDecl(Environment gamma, String name, EList<ProtocolStatement> body, Type_finalprotocol p1) {
		super();
		this.gamma = gamma;
		this.name = name;
		this.body = body;
