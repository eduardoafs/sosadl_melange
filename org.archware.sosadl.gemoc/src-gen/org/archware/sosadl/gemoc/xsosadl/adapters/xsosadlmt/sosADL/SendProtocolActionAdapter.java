...
public class SendProtocolActionAdapter extends EObjectAdapter<SendProtocolAction> implements org.archware.sosadl.gemoc.xsosadlmt.sosADL.SendProtocolAction {
  ...
  public EClass eClass() {
    return org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.eINSTANCE.getSendProtocolAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.gemoc.xsosadlmt.sosADL.SosADLPackage.SEND_PROTOCOL_ACTION__EXPRESSION:
