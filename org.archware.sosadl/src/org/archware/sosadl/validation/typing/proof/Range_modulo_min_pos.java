...
public class Range_modulo_min_pos implements Range_modulo_min {
	@Mandatory
	...
	public Range_modulo_min_pos(Expression lmin, Expression lmax, Expression rmin, Expression rmax, Expression min,
