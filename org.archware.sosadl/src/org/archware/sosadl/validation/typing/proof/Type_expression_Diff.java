...
@CoqNoStandalone
public class Type_expression_Diff<T> implements Type_expression_node<T> {
	@Mandatory
	...
	public Type_expression_Diff(Environment gamma, Expression l, DataType l__tau, Expression l__min, Expression l__max,
