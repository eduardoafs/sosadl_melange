...
public class ConstituentAdapter extends EObjectAdapter<Constituent> implements org.archware.sosadl.sosADL.Constituent {
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getConstituent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.CONSTITUENT__NAME:
    		return getName();
    	case org.archware.sosadl.sosADL.SosADLPackage.CONSTITUENT__VALUE:
    		return getValue();
    }
