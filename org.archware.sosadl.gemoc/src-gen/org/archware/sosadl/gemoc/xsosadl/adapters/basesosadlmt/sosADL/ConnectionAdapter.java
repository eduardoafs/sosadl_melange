...
public class ConnectionAdapter extends EObjectAdapter<Connection> implements org.archware.sosadl.sosADL.Connection {
  ...
  public void setValueType(final DataType o) {
    if (o != null)
    	adaptee.setValueType(((org.archware.sosadl.gemoc.xsosadl.adapters.basesosadlmt.sosADL.DataTypeAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.archware.sosadl.sosADL.SosADLPackage.eINSTANCE.getConnection();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.archware.sosadl.sosADL.SosADLPackage.CONNECTION__ENVIRONMENT:
    		return isEnvironment() ? Boolean.TRUE : Boolean.FALSE;
    	case org.archware.sosadl.sosADL.SosADLPackage.CONNECTION__NAME:
    		return getName();
    	case org.archware.sosadl.sosADL.SosADLPackage.CONNECTION__MODE:
    		return getMode();
    	case org.archware.sosadl.sosADL.SosADLPackage.CONNECTION__VALUE_TYPE:
    		return getValueType();
    }
